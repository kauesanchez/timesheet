class UserController < ApplicationController
  ...
  def send_password
    ...
    if u and u.send_new_password
      ...
      flash[:notice]  = "No user matches this e-mail. Contact al@disperseinteractive.com for further info"
  ...
  def index
    @users = User.all
    redirect_to :controller=>'reports'  if session[:user].role != User::ADMIN
  end
