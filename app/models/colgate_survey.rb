class ColgateSurvey < Survey
    ...
    QUESTION[8] = {:title=>"Please drag 3 dental products below that you use the most (order of importance).",:fields=>[:toothpaste_words]}
    QUESTION[9] = {:title=>"Why did you select -- as your most important?",:fields=>[:toothpaste_word_why]}
    QUESTION[10] = {:title=>"Of the top three you have selected what would motivate you to change the order of importance?",:fields=>[:samplings]}
    ...
    QUESTION[20] = {:title=>"Where do you go to the most to buy your oral care products? Please click on only one.",:fields=>[:purchase_id]}
